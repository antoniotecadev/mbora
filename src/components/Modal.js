  ...
  return (
    <View style={styles.centeredView}>
      <Modal
        ...
        <Maps clientName={props.clientName} coordinate={coordinate} setCoordinate={setCoordinate} actionMap={0} companyName={props.companyName} companyCoordinate={props.companyCoordinate} companyNameAndCoordinate={props.companyNameAndCoordinate} isDetails={props.isDetailsEncomenda} isEditCompanyCoordinate={false}/>
        <View style={styles.centeredView}>
