...
export const AlertDialog = ({showDialog, setShowDialog, titulo, mensagem, cor, isEncomenda = false, userTelephone = null, clientAddress = null, moreDetails = null, isDetailsEncomenda = false, clientCoordinate, clientPhoto = null, onPress})=> {
    ...
    const ClientPhoto = ()=> {
      ...
      return (
        <ViewUILIB center margin-15 style={styles.containerPhoto}>
          <ImageCache style={[styles.image, styles.imageShadow]} {...{preview, uri: clientPhoto}}/>
        </ViewUILIB>
      )
    }
