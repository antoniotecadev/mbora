            ...
            <TabController asCarousel={true} initialIndex={0} onChangeIndex={(index)=> onChangeIndex(index)} items={[{ label: 'Encomendas' }, { label: 'Favoritos' }, { label: 'A seguir' }]}>
                ...
                <TabController.PageCarousel>
                    <TabController.TabPage index={0}>
                        <Encomenda isUser={true} appearanceColor={color} fetchEncomendas={fetchEncomendas} encomendas={encomendas} onRefresh={()=> onRefresh(0)} refreshing={refreshing} empty={empty.encomenda}/>
